...
def main(args):
    ...
    # load image
    pil_image = (Image.open(args.image_path).convert("RGB")).resize((args.image_size, args.image_size))
    img = pil_image
    # # preprocess
    # size_org = img.size
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-path", type=str, default="/home/uas-dtu/Downloads/PXL_20240822_183505333.jpg")
    parser.add_argument("--output-dir", type=str, default="lol_dataset/val/high")
    ...
    parser.add_argument("--vq-ckpt", type=str, default="checkpoints/0005000.pt", help="ckpt path for vq model")
